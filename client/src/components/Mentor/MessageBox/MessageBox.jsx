...
import handleMentorMessage from "@/handler/handleMentorMessage";
...
export default function MessageBox() {
  ...
  //mentor message handler
  const mentorMessageFormHandler = async (event) => {
    event.preventDefault();
    //before sending message check if the user authenticate or not
    ...
    if (message.length === 0 || !mentorId) return;
    const res = await handleMentorMessage(mentorId, message);
    console.log(res);
  };
  return (
